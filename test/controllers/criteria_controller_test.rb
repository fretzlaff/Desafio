...
class CriteriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create criterium" do
    assert_difference('Criterium.count') do
      post criteria_url, params: { criterium: { rule: @criterium.rule, target_id: @criterium.target_id, type: @criterium.type, value: @criterium.value } }
    end
  ...
  test "should update criterium" do
    patch criterium_url(@criterium), params: { criterium: { rule: @criterium.rule, target_id: @criterium.target_id, type: @criterium.type, value: @criterium.value } }
